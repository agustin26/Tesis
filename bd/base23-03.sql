...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2023 a las 19:49:02
...
INSERT INTO `clientes` (`id_cliente`, `dni_cliente`, `nombre_cliente`, `apellido_cliente`, `telefono_cliente`, `direccion_cliente`, `fecha_alta`, `estado`) VALUES
(5, '159966666', 'Jorge', 'Rodriguez', '459966666', 'california', '2018-02-05', '1'),
(6, '45', 'karla', 'rodriguez', '789', 'chicago', '2018-02-13', '1');
...
(5, '2023-03-12', 'F000007', 'roberto perez', '45965', 'eyter', 'USD$', 'USD$ 96', 'EFECTIVO', '1', 1, 4),
(6, '2023-03-12', 'F000008', 'roberto perez', '45965', 'eyter', 'USD$', '160', 'CHEQUE', '1', 1, 4),
(7, '2023-03-12', 'F000009', 'roberto perez', '45965', 'eyter', 'USD$', '100', 'EFECTIVO', '1', 1, 4),
(8, '2023-03-13', 'F000010', 'luis lopez', '14789', 'eyter', 'USD$', '400', 'EFECTIVO', '1', 1, 3);
...
(6, 'F000005', '45965', 9, 'jabon casa', 'USD$', '80', '1', '0', '80', '2023-03-12', 1, 4, '1', 6),
(7, 'F000006', '45965', 9, 'jabon casa', 'USD$', '80', '1', '0', '80', '2023-03-12', 1, 4, '1', 6),
(8, 'F000007', '45965', 9, 'jabon casa', 'USD$', '80', '1', '0', '80', '2023-03-12', 1, 4, '1', 6),
(9, 'F000008', '45965', 9, 'jabon casa', 'USD$', '80', '1', '0', '80', '2023-03-12', 1, 4, '1', 6),
(10, 'F000008', '45965', 9, 'jabon casa', 'USD$', '80', '1', '0', '80', '2023-03-12', 1, 4, '1', 6),
(11, 'F000009', '45965', 4, 'jabon ACE', 'USD$', '100', '1', '0', '100', '2023-03-12', 1, 4, '1', 6),
(12, 'F000010', '14789', 4, 'jabon ACE', 'USD$', '100', '4', '0', '400', '2023-03-13', 1, 3, '1', 6);
...
(6, 2, 'aceite carro', 'USD$', '100', '300', '0', '0', '216717336.jpg', '2018-01-25', 1),
(7, 7, 'harina pan', 'USD$', '60', '90', '0', '1', '234611002.jpg', '2018-01-30', 1),
(8, 7, 'pan ', 'USD$', '60', '81', '0', '1', '1407078505.jpg', '2018-01-24', 1),
(9, 6, 'jabon casa', 'USD$', '80', '200', '3', '1', '1121250455.jpg', '2018-01-29', 1);
...
--
ALTER TABLE `detalle_compras`
  MODIFY `id_detalle_compras` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `usuario_permiso`
  MODIFY `id_usuario_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
