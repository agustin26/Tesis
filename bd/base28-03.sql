...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2023 a las 22:27:08
...
(4, 6, 'jabon ACE', 'USD$', '100', '200', '20', '1', '1982969361.jpg', '2018-01-31', 1),
(6, 2, 'aceite carro', 'USD$', '100', '300', '20', '0', '216717336.jpg', '2018-01-25', 1),
(7, 7, 'harina pan', 'USD$', '60', '90', '20', '1', '234611002.jpg', '2018-01-30', 1),
(8, 7, 'pan ', 'USD$', '60', '81', '20', '1', '1407078505.jpg', '2018-01-24', 1),
(9, 6, 'jabon casa', 'USD$', '80', '200', '20', '1', '1121250455.jpg', '2018-01-29', 1);
...
ALTER TABLE `cuentas_corrientes`
  ...
  ADD KEY `dni_cliente_fkcc_idx` (`dni_cliente`);
...
ALTER TABLE `detalle_cuentas_corrientes`
  ...
  ADD KEY `dni_cliente_fkdc_idx` (`dni_cliente`),
  ADD KEY `id_cc_fkdc_idx` (`id_cuenta_corriente`),
...
--
ALTER TABLE `cuentas_corrientes`
  ADD CONSTRAINT `dni_cliente_fkcc` FOREIGN KEY (`dni_cliente`) REFERENCES `clientes` (`id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `detalle_cuentas_corrientes`
  ADD CONSTRAINT `dni_cliente_fkdc` FOREIGN KEY (`dni_cliente`) REFERENCES `clientes` (`id_cliente`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `id_cc_fkdc` FOREIGN KEY (`id_cuenta_corriente`) REFERENCES `cuentas_corrientes` (`id_cuentas_corrientes`) ON DELETE NO ACTION ON UPDATE NO ACTION,
