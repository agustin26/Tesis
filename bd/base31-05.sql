...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2023 a las 20:32:49
...
(9, 3, 47, '2023-05-22 15:25:14', '200', 10, 1, 'adeuda', 'f'),
(10, 3, 48, '2023-05-22 15:37:49', '81', 10, 1, 'adeuda', 'f'),
(20, 3, NULL, '2023-05-29 22:43:19', '10', 10, 1, 'Pago a cuenta', 'p'),
(29, 3, NULL, '2023-05-29 23:14:36', '60', 10, 1, 'Pago a cuenta', 'p'),
(30, 3, NULL, '2023-05-29 23:58:04', '1', 10, 1, 'Pago a cuenta', 'p'),
(31, 3, NULL, '2023-05-29 23:59:08', '10', 10, 1, 'Pago a cuenta', 'p'),
(34, 1, 51, '2023-05-30 00:10:14', '200', 8, 1, 'adeuda', 'f'),
(35, 1, NULL, '2023-05-30 21:03:14', '100', 8, 1, 'Pago a cuenta', 'p');
...
(55, 'F000038', '23423424', 9, 'jabon casa', '200', '1', '0', '200', '2023-05-22', 1, 10, 1),
(56, 'F000039', '23423424', 8, 'pan ', '81', '1', '0', '81', '2023-05-22', 1, 10, 1),
(57, 'F000040', '44011633', 4, 'jabon ACE', '200', '1', '0', '200', '2023-05-30', 1, 8, 1),
(58, 'F000041', '44011633', 4, 'jabon ACE', '200', '1', '0', '200', '2023-05-30', 1, 8, 1),
(59, 'F000042', '44011633', 4, 'jabon ACE', '200', '1', '0', '200', '2023-05-30', 1, 8, 0);
...
(4, 6, 'jabon ACE', '200', '10', '1', NULL, 1, NULL),
...
(47, '2023-05-22', 'F000038', 'martin', '23423424', 'eyter', '200', 'CUENTA CORRIENTE', 1, 1, 10),
(48, '2023-05-22', 'F000039', 'martin', '23423424', 'eyter', '81', 'CUENTA CORRIENTE', 1, 1, 10),
(49, '2023-05-30', 'F000040', 'Belen', '44011633', 'admin', '200', 'CUENTA CORRIENTE', 0, 1, 8),
(50, '2023-05-30', 'F000041', 'Belen', '44011633', 'admin', '200', 'CUENTA CORRIENTE', 0, 1, 8),
(51, '2023-05-30', 'F000042', 'Belen', '44011633', 'admin', '200', 'CUENTA CORRIENTE', 1, 1, 8);
...
--
ALTER TABLE `detalle_cuentas_corrientes`
  MODIFY `id_detalle_cc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `detalle_ventas`
--
ALTER TABLE `detalle_ventas`
  MODIFY `id_detalle_ventas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `ventas`
  MODIFY `id_ventas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
